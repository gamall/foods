...
using Syngenta.Web.FoodStandards.Filters;
using Syngenta.Web.FoodStandards.Models;
using Syngenta;
using Syngenta.Core;
...
namespace Syngenta.Web.FoodStandards.Controllers
{
    ...
    public class AccountController : SyngentaBaseController
    {
        ...
        public ActionResult Login(string returnUrl, FormCollection form)
        {
            ...
            //if (WebSecurity.GetPasswordFailuresSinceLastSuccess(form["Email"]) >= 5
        ...
        private static string ErrorCodeToString(MembershipCreateStatus createStatus)
        {
            ...
            switch (createStatus)
            {
                case MembershipCreateStatus.DuplicateUserName:
                    return "Email address already registered. Please register using a different email address";
